...
class Login:
    def __init__(self,root):
        self.root=root
        self.root.title("RIMT-IITD Attendance System | Login")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            messagebox.showinfo("Sussessfully","Welcome to RIMT-IITD Attendance Management System Using Facial Recognition")
        else:
