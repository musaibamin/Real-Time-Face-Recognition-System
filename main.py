...
from attendance_panel import Attendance
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        self.root.title("RIMT-IITD Attendance System")
        ...
        # title section
        title_lb1 = Label(bg_img, text="RIMT-IITD Attendance System Using Facial Recognition", font=("verdana", 20, "bold"),
        ...
        std_b1_1 = Button(bg_img, command=self.student_pannels, text="Register Student", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        std_b1_1.place(x=250, y=280, width=180, height=45)

        # Attendance System button 2
        att_img_btn = Image.open(r"./Images_GUI/att.jpg")
        att_img_btn = att_img_btn.resize((180, 180), Image.LANCZOS)
        self.att_img1 = ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img, command=self.attendance_pannel, image=self.att_img1, cursor="hand2", )
        att_b1.place(x=480, y=100, width=180, height=180)

        att_b1_1 = Button(bg_img, command=self.attendance_pannel, text="Dashboard", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        att_b1_1.place(x=480, y=280, width=180, height=45)

        # Face Detector button 3
        det_img_btn = Image.open(r"./Images_GUI/det1.jpg")
        det_img_btn = det_img_btn.resize((180, 180), Image.LANCZOS)
        self.det_img1 = ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img, command=self.face_rec, image=self.det_img1, cursor="hand2", )
        det_b1.place(x=710, y=100, width=180, height=180)

        det_b1_1 = Button(bg_img, command=self.face_rec, text="Attendance Mark", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        det_b1_1.place(x=710, y=280, width=180, height=45)
        ...
        dev_b1.place(x=250, y=330, width=180, height=180)

        dev_b1_1 = Button(bg_img, command=self.developr, text="Developers", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        dev_b1_1.place(x=250, y=510, width=180, height=45)

        # Help Support button 6
